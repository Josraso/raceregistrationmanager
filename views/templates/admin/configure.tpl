        ...
        <div class="panel">
            ...
            <div id="configRaceAccordionBody" class="panel-collapse collapse {if !$isConfigured}in{/if}">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3">{l s='Página CMS para publicación' mod='raceregistrationmanager'}</label>
                        <div class="col-lg-9">
                            <select name="cms_page_id" class="form-control">
                                <option value="0">-- {l s='Selecciona una página CMS' mod='raceregistrationmanager'} --</option>
                                {foreach from=$cms_pages item=cms}
                                    <option value="{$cms.id_cms}" {if isset($cms_page_id) && $cms_page_id == $cms.id_cms}selected{/if}>
                                        {$cms.meta_title}
                                    </option>
                                {/foreach}
                            </select>
                            <p class="help-block">{l s='Página donde se publicarán las inscripciones de esta carrera' mod='raceregistrationmanager'}</p>
                        </div>
                    </div>
