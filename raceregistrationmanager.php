    ...
    public function install()
{
    ...
    private function saveRaceConfiguration($id_product, $config)
    {
        $data = [
            ...
            'cms_page_id' => (int)$config['cms_page_id'],
    ...
    private function processConfiguration($id_product)
    {
        ...
        $config = [
            ...
            'cms_page_id' => (int)Tools::getValue('cms_page_id'),
            'settings' => []
        ];
    ...
    private function getTemplateVariables($id_product = null)
    {
        ...
        return [
            ...
            'cms_page_id' => $raceConfig['cms_page_id'],
    ...
    private function getCMSPages()
    {
        return Db::getInstance()->executeS('
            ...
            LEFT JOIN `'._DB_PREFIX_.'cms_lang` cl ON (
                c.id_cms = cl.id_cms 
